...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/vnd.doge.payment.payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/vnd.doge.payment.ack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/vnd.doge.payment.ack" && data.count <= 50000 {
